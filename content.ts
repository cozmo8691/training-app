export const home = {
  ...
  published: {
    hero: {
      title: 'A beautiful training portal base for your whole organisation.',
      body: 'High performing teams use UpTrain to manage their training. Some other cool SaaS tag line here.',
    },
    features: [
      {
